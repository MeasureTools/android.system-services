...
public class CPUTemperatureSupplierService extends ValueSupplierService  {

	private ByteBuffer valueByteBuffer;

	public CPUTemperatureSupplierService() {
		super("ODROID_XU3_CPU_TEMPERATURE");
	...
	private Double readValue() {
		...
		try {
			bufReader = new BufferedReader(new FileReader("/sys/class/thermal/thermal_zone0/temp"));
